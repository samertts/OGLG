...
class Letter:
    ...
    signatures: list[SignatureMetadata] = field(default_factory=list)
    ...
    def archive(self, user_id: str, reason: str = "") -> None:
        ...
        validate_archive_transition(self.archive_state, ArchiveState.ARCHIVED)
        self.status = LetterStatus.ARCHIVED
        self.archive_state = ArchiveState.ARCHIVED
    ...
    def restore(self, user_id: str, reason: str = "") -> None:
        ...
        validate_archive_transition(self.archive_state, ArchiveState.ACTIVE)
        self.status = LetterStatus.RESTORED
        self.archive_state = ArchiveState.ACTIVE
    ...
    def soft_delete(self, user_id: str, reason: str = "") -> None:
        ...
        validate_archive_transition(self.archive_state, ArchiveState.SOFT_DELETED)
        self.status = LetterStatus.DELETED
        self.archive_state = ArchiveState.SOFT_DELETED
